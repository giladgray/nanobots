...
module.exports = function(pocket) {
  ...
  g2d = canvas.g2d;
  pocket.component('bullet', {
    size: 10,
    damage: 1
  });
  pocket.component('lifetime', function(cmp, _arg) {
    var born, time;
    time = _arg.time, born = _arg.born;
    cmp.born = born || pocket.time;
    return cmp.time = time;
  });
  pocket.systemForEach('lifetime', ['lifetime'], function(pocket, key, lifetime) {
    if ((lifetime.time != null) && pocket.time - lifetime.born >= lifetime.time) {
      return pocket.destroyKey(key);
    }
  });
  pocket.system('draw-bullets', ['bullet', 'position'], function(pocket, keys, bullets, positions) {
    var key, size, x, y, _i, _len, _ref;
    g2d.beginPath();
    g2d.fillStyle = 'black';
    for (_i = 0, _len = keys.length; _i < _len; _i++) {
      key = keys[_i];
      _ref = positions[key], x = _ref.x, y = _ref.y;
      size = bullets[key].size;
      g2d.moveTo(x, y);
  ...
  return pocket.system(PairSystem.forEach('bullet-enemy-collision', ['bullet', 'position', 'velocity'], ['enemy', 'position', 'health'], function(pocket, _arg, _arg1) {
    var bKey, bPos, bRectNow, bRectPrev, bVel, bullet, eHP, eKey, ePos, eRect, enemy;
    bKey = _arg[0], bullet = _arg[1], bPos = _arg[2], bVel = _arg[3];
    eKey = _arg1[0], enemy = _arg1[1], ePos = _arg1[2], eHP = _arg1[3];
    ...
    if (Rectangle.overlap(bRectNow, eRect) || Rectangle.overlap(bRectPrev, eRect)) {
      pocket.destroyKey(bKey);
      return eHP.health -= bullet.damage;
    }
  }));
};


},{"pocket/src/utils/pair-system.coffee":12,"pocket/src/utils/rectangle.coffee":13}],2:[function(require,module,exports){
var Vector;

Vector = require('pocket/src/utils/vector.coffee');

module.exports = function(pocket, nanobotKey) {
  var canvas, g2d;
  if (!nanobotKey) {
    throw new Error('undefined nanobot key');
  }
  canvas = pocket.getData('canvas');
  ...
  pocket.system('enemies-target', ['enemy', 'position', 'velocity'], function(pocket, keys, enemies, positions, velocities) {
    var enemy, key, nanobotPosition, position, targetAngle, _i, _len, _results;
    ...
    for (_i = 0, _len = keys.length; _i < _len; _i++) {
      ...
      _results.push(velocities[key] = Vector.fromPolar(enemy.speed, targetAngle));
    }
    return _results;
  });
  g2d = canvas.g2d;
  pocket.systemForEach('draw-enemy', ['enemy', 'position', 'velocity'], function(pocket, key, enemy, position, velocity) {
    var size;
    size = enemy.size;
    g2d.save();
    g2d.beginPath();
  ...
  pocket.system('enemy-health', ['enemy', 'health'], function(pocket, keys, enemies, healths) {
    var key, killed;
    killed = (function() {
    ...
    if (killed.length) {
      return console.log("killed " + killed.length + " baddies");
    }
  });
  return {
    newEnemy: function() {
...
},{"pocket/src/utils/vector.coffee":14}],3:[function(require,module,exports){
var Canvas2D, KeyboardState, MouseState, Pocket;
...
module.exports = function(options) {
  ...
  pocket.system('clear-canvas', [], function(pocket) {
    return canvas.g2d.clearRect(0, 0, canvas.width, canvas.height);
  });
  pocket.start = function(time) {
    pocket.tick(time);
    return pocket.frameId = window.requestAnimationFrame(pocket.start);
  };
  pocket.stop = function() {
    return window.cancelAnimationFrame(pocket.frameId);
  };
  return pocket;
};


},{"pocket":7,"pocket/src/utils/canvas-2d.coffee":9,"pocket/src/utils/keyboard-state.coffee":10,"pocket/src/utils/mouse-state.coffee":11}],4:[function(require,module,exports){
var PairSystem, Vector, bullets, enemies, keyboard, nanobot, pocket;
...
pocket.component('rotation', {
  angle: 0
});

pocket.component('health', {
  health: 100
});
...
pocket.system('spawn-enemy', [], function(pocket) {
  if (keyboard.isNewPress('SPAWN')) {
    return enemies.newEnemy();
  }
});

pocket.systemForEach('move-keys', ['position', 'velocity'], function(pocket, key, pos, vel) {
...
},{"./bullets.coffee":1,"./enemies.coffee":2,"./engine.coffee":3,"./nanobot.coffee":5,"pocket/src/utils/pair-system.coffee":12,"pocket/src/utils/vector.coffee":14}],5:[function(require,module,exports){
var Vector;

Vector = require('pocket/src/utils/vector.coffee');

module.exports = function(pocket) {
  var canvas, g2d, key, keyboard, mouse;
  ...
  pocket.systemForEach('move-nanobot', ['nanobot', 'velocity', 'human-powered'], function(pocket, key, nanobot, velocity) {
    if (keyboard.down.UP) {
    ...
    if (keyboard.down.LEFT) {
      return velocity.x = -nanobot.speed;
  ...
  pocket.systemForEach('rotate-nanobot', ['nanobot', 'position', 'rotation', 'human-powered'], function(pocket, key, nanobot, position, rotation) {
    var mouseVector;
    mouseVector = Vector.sub(mouse.cursor, position, true);
    return rotation.angle = Vector.angle(mouseVector);
  });
  pocket.systemForEach('fire-rifle', ['nanobot', 'position', 'rotation', 'rifle', 'human-powered'], function(pocket, key, nanobot, position, rotation, rifle) {
    if (!(mouse.buttons.left && pocket.time - rifle.lastFired >= rifle.fireRate)) {
      return;
    }
    ...
    return pocket.key({
      ...
      bullet: {
        size: rifle.bullet.size,
        damage: rifle.bullet.damage
      },
      velocity: Vector.fromPolar(rifle.bullet.speed, rotation.angle),
      lifetime: {
        time: rifle.bullet.time
      }
    });
  });
  g2d = canvas.g2d;
  pocket.systemForEach('draw-nanobot', ['nanobot', 'position', 'rotation'], function(pocket, key, nanobot, position, rotation) {
    var size;
    size = nanobot.size;
    g2d.save();
    g2d.beginPath();
...
},{"pocket/src/utils/vector.coffee":14}],6:[function(require,module,exports){
(function (global){
/**
 * @license
...
Pocket = (function() {
  ...
  Pocket.prototype.component = function(name, initializer) {
    ...
    if (_.isFunction(initializer)) {
      ...
      compFn = function(defaults, comp, options) {
        if (options == null) {
          options = {};
        }
        _.defaults(comp, _.clone(defaults, true));
        return _.assign(comp, options);
      };
  ...
  Pocket.prototype.filterKeys = function() {
    ...
    componentHasKey = (function(_this) {
      return function(name) {
        var _ref;
        return ((_ref = _this._components[name]) != null ? _ref[id] : void 0) != null;
      };
    })(this);
    return (function() {
      var _results;
  ...
  Pocket.prototype.system = function(name, reqs, fn) {
    return this._systems.push(name instanceof System ? name : new System(name, reqs, fn));
  };
...
pocket.systemForEachPair 'square-barrier-collision',
  ['square', 'amazing'],
  ['barrier', 'evil'],
  (pocket, [aKey, square], [bKey, barrier]) ->
 */



},{"./system.coffee":8,"lodash":6}],8:[function(require,module,exports){
var System, _,
  __slice = [].slice;
...
module.exports = System = (function() {
  ...
  System.forEach = function(name, reqs, fn) {
    ...
    action = function() {
      ...
      for (_i = 0, _len = keys.length; _i < _len; _i++) {
        key = keys[_i];
        values = components.map(function(cmp) {
          return cmp[key];
        });
...
KeyboardState.convertKeymap = function(keymap) {
  var key, name;
  if (keymap == null) {
    keymap = {};
  }
...
module.exports = function(cmp, _arg) {
...
PairSystem = (function(_super) {
  __extends(PairSystem, _super);

  function PairSystem(name, requiredA, requiredB, actionFn) {
    this.actionFn = actionFn;
    PairSystem.__super__.constructor.call(this, name, requiredA, this.action);
    if (!Array.isArray(requiredB)) {
      throw new Error('PairSystem requires two requiredComponents arrays');
    }
    if (typeof this.actionFn !== 'function') {
      throw new Error('System requires action Function');
    }
    this.requiredComponentsB = requiredB;
  }

  PairSystem.prototype.action = function() {
    var keysA, keysB, pocket, reqsA, reqsB;
    pocket = arguments[0], keysA = arguments[1], reqsA = 3 <= arguments.length ? __slice.call(arguments, 2) : [];
    reqsB = this.requiredComponentsB.map(function(name) {
      return pocket.getComponent(name) || {};
    });
    keysB = pocket.filterKeys(this.requiredComponentsB);
    return this.actionFn.call(this, pocket, [keysA].concat(__slice.call(reqsA)), [keysB].concat(__slice.call(reqsB)));
  };

  PairSystem.forEach = function(name, reqsA, reqsB, fn) {
    var action;
    action = function(pocket, _arg, _arg1) {
      var cmpsA, cmpsB, keyA, keyB, keysA, keysB, valuesA, valuesB, _i, _len, _results;
      keysA = _arg[0], cmpsA = 2 <= _arg.length ? __slice.call(_arg, 1) : [];
      keysB = _arg1[0], cmpsB = 2 <= _arg1.length ? __slice.call(_arg1, 1) : [];
      _results = [];
      for (_i = 0, _len = keysA.length; _i < _len; _i++) {
        keyA = keysA[_i];
        valuesA = cmpsA.map(function(cmp) {
          return cmp[keyA];
        });
        _results.push((function() {
          var _j, _len1, _results1;
          _results1 = [];
          for (_j = 0, _len1 = keysB.length; _j < _len1; _j++) {
            keyB = keysB[_j];
            valuesB = cmpsB.map(function(cmp) {
              return cmp[keyB];
            });
            _results1.push(fn(pocket, [keyA].concat(__slice.call(valuesA)), [keyB].concat(__slice.call(valuesB))));
          }
          return _results1;
        })());
      }
...
},{"../system.coffee":8}],13:[function(require,module,exports){
...
module.exports = Rectangle = {
  ...
  centered: function(x, y, width, height) {
    if (x == null) {
      x = 0;
    }
    if (y == null) {
...
module.exports = Vector2 = {
  ...
  fromPolar: function(radius, angle) {
    ...
    return Vector2["new"](normalize(radius * Math.cos(angle)), normalize(radius * Math.sin(angle)));
  },
  equal: function(v1, v2) {
    return v1.x === v2.x && v1.y === v2.y;
  },
  add: function(v1, v2, clone) {
    if (clone == null) {
      clone = false;
    }
    if (clone) {
  ...
  invert: function(v, clone) {
    if (clone == null) {
      clone = false;
    }
    return Vector2.scale(v, -1, clone);
  },
  angle: function(v) {
